...
Hey there, social media adventurers! 👋 Tired of the same old messaging apps? Meet **Textify** – your new secret weapon for fun, anonymous communication! 🚀 Think of it as the cool, open-source cousin of those anonymous messaging platforms. 😎

![Textify Screenshot](src/app/opengraph-image.jpg)

## Why Textify? Because Secrets are Fun! 🤫
...
1. 👯‍♀️ Clone the repo to your machine
   ```bash
   git clone https://github.com/Harshithparsa/TEXTIFY.git
   ```
2. 📦 Install the magic packages
   ```bash
   npm install
   ```
3. 🔐 Create a `.env` file and fill in required details (DATABASE_URL, CLERK_SECRET_KEY, etc.)
...
**Made with ❤️ by [Harshith](https://github.com/Harshithparsa)**

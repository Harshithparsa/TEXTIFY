...
const Twit = ({ linkprop }: Props) => {
  return (
    <a
      href={`https://twitter.com/intent/tweet?text=Hey!%20Send%20me%20anonymous%20messages%20in%20Textify%20.%20I%20will%20never%20know%20who%20had%20send%20it%20XD%20%20&url=${linkprop}`}
      target="_blank"
